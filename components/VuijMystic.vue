...
const calcPosition = (triggerRect: DOMRect) => {
    ...
    if (props.autoPosition) {
        ...
        const calcPlacement = (position: any) => {
            ...
            // if(props.hasArrow) console.warn('--->', {pTop, pLeft, width, height});
        ...
        basePositionKeys.forEach(place => {
            ...
            // if(props.hasArrow) console.log('calcPlacement', place, {altPlacement: placeAlts[place]});
        });
...
const contentInfo = computed(() => {
    ...
    if (triggerRef.value && contentRect.value) {
        ...
        info.style = {
            ...
            // zIndex: props.minZIndex + 1,
            zIndex: getApproximateMaxZIndex() + 1, //computed open/close=-1
        }
